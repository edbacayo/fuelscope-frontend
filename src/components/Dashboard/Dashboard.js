                ...
                <div className="accordion-item">
                    <h2 className="accordion-header" id="headingReminders">
                        <button
                            ...
                            data-bs-target="#collapseReminders"
                            aria-expanded="true"
                            aria-controls="collapseReminders"
                        >
                            Upcoming Service Reminders ({upcomingReminders.length})
                        </button>
                    </h2>
                    <div
                        id="collapseReminders"
                        className="accordion-collapse collapse show"
                        aria-labelledby="headingReminders"
                ...
                <div className="container d-flex flex-wrap align-items-center justify-content-between">
                    <div className="d-flex flex-wrap">
                        <div className="me-3 mb-2">
                            <label htmlFor="yearFilter" className="form-label mb-0">
                                Year
                            </label>
                            <select
                                id="yearFilter"
                        ...
                        <div className="me-3 mb-2">
                            <label htmlFor="monthFilter" className="form-label mb-0">
                                Month
                            </label>
                            <select
                                id="monthFilter"
            ...
            <div className="row g-3">
                ...
                <div className="col-lg-3 col-md-6 col-6 d-flex">
                    <div className="card shadow-sm p-3 text-center flex-grow-1">
                        ...
                        >
                            ₱
                            {totalInsuranceCost.toLocaleString("en-PH", {
                ...
                <div className="col-lg-3 col-md-6 col-6 d-flex">
                    <div className="card shadow-sm p-3 text-center flex-grow-1">
                        ...
                        >
                            ₱
                            {totalRegistrationCost.toLocaleString("en-PH", {
                                minimumFractionDigits: 2,
                            })}
                        </p>
                    </div>
                            ...
                            {paginatedExpenses.length > 0 ? (
                                paginatedExpenses.map((expense) => (
                                    <tr key={expense._id}>
                                        ...
                                        <td>
                                            {expense.type === "fuel" &&
                                                `Fuel: ${expense.fuelDetails?.fuelBrand}`}
                                            {expense.type === "service" &&
                                                `Service: ${expense.serviceDetails?.serviceType}`}
                                            {expense.type === "insurance" && "Insurance Payment"}
                                            {expense.type === "registration" &&
                                                "Vehicle Registration"}
                                        </td>
                                        <td>
                                            {expense.fuelDetails?.pricePerLiter.toLocaleString(
                                                "en-US",
                                                {
                                                    minimumFractionDigits: 2,
                                        ...
                                        <td>
                                            {expense.odometer ? `${expense.odometer} km` : "N/A"}
                                        </td>
                                        <td>
                                            <button
                                                className="btn btn-danger rounded-pill btn-sm text-smaller"
                                                onClick={() =>
                                                    handleDeleteExpense(expense._id, expense.type)
                                                }
                                            >
                                                Delete
                                            </button>
                    ...
                    <nav>
                        <ul className="pagination justify-content-center mt-3">
                            ...
                            {Array.from({ length: totalExpensePages }, (_, i) => (
                                <li
                                    key={`page-${i}`}
                                    className={`page-item ${expensePage === i + 1 ? "active" : ""}`}
                                >
                                    <button
                                        className="page-link"
                            ...
                            <li
                                className={`page-item ${
                                    expensePage === totalExpensePages ? "disabled" : ""
                                }`}
                            >
                                <button
                                    className="page-link"
